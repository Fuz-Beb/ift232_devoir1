...
import jarvis.atoms.primitives.booleans.BoolPrimitiveAnd;
import jarvis.atoms.primitives.booleans.BoolPrimitiveNot;
import jarvis.atoms.primitives.booleans.BoolPrimitiveOr;
...
import jarvis.atoms.primitives.integers.IntegerPrimitiveGreaterThan;
import jarvis.atoms.primitives.integers.IntegerPrimitiveLessThan;
...
public class JarvisInterpreter {
	...
	private void addCheaterCode() {
		...
		environment.put("_integerGreaterThanPrimitive", new IntegerPrimitiveGreaterThan());
		environment.put("_integerLessThanPrimitive", new IntegerPrimitiveLessThan());
	...
	public void message() {
		...
		// Un message d'avertissement demeure si vous obtenez "ComprendPas". L'interpr�teur crash �galement.
