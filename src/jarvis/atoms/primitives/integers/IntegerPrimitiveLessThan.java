...
/*
* Cette classe implante la partie de l'op�ration primitive sp�cifique a la comparaison (plus petit que) 
*/

public class IntegerPrimitiveLessThan extends IntegerPrimitiveOperation
{
    @Override
